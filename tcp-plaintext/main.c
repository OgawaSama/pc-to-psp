...
int check_button(char* msg, SceCtrlData *pad) {
	...
	{	
		strcpy(msg, "Left pad pressed!\n");
	}
	if (pad->Buttons & PSP_CTRL_UP)
	{
		strcpy(msg, "Up pad pressed!\n");
	}
	if (pad->Buttons & PSP_CTRL_RIGHT)
	{
		strcpy(msg, "Right pad pressed!\n");
	}
	if (pad->Buttons & PSP_CTRL_DOWN)
	{
		strcpy(msg, "Down pad pressed!\n");
	}

	// symbols
	if (pad->Buttons & PSP_CTRL_SQUARE)
	{
		strcpy(msg, "Square pressed!\n");
	}
	if (pad->Buttons & PSP_CTRL_TRIANGLE)
	{
		strcpy(msg, "Triangle pressed!\n");
	}
	if (pad->Buttons & PSP_CTRL_CIRCLE)
	{
		strcpy(msg, "Circle pressed!\n");
	}
	if (pad->Buttons & PSP_CTRL_CROSS)
	{
		strcpy(msg, "Cross pressed!\n");
	}

	// bumpers
	if (pad->Buttons & PSP_CTRL_LTRIGGER)
	{
		strcpy(msg, "Left trigger pressed!\n");
	}
	if (pad->Buttons & PSP_CTRL_RTRIGGER)
	{
		strcpy(msg, "Right trigger pressed!\n");
	}

	// extras
	if (pad->Buttons & PSP_CTRL_START)
	{
		strcpy(msg, "Start pressed!\n");
		return 1;
	}
	if (pad->Buttons & PSP_CTRL_SELECT)
	{
		strcpy(msg, "Select pressed!\n");
		return 2;
	}
	...
	{
		strcpy(msg, "Screen pressed!\n");
	}
	if (pad->Buttons & PSP_CTRL_HOLD)
	{
		strcpy(msg, "Hold pressed!\n");
	}
	if (pad->Buttons & PSP_CTRL_NOTE)
	{
		strcpy(msg, "Note pressed!\n");
	}
	if (pad->Buttons & PSP_CTRL_HOME)
	{
		strcpy(msg, "Home pressed!\n");
	}
